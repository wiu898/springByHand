...
import com.gupao.spring.framework.aop.GPDefaultAopProxyFactory;
import com.gupao.spring.framework.aop.support.GPAdvisedSupport;
import com.gupao.spring.framework.aop.config.GPAopConfig;
import com.gupao.spring.framework.aop.support.GPDefaultListableBeanFactory;
...
public class GPApplicationContext implements GPBeanFactory {
    ...
    private GPDefaultListableBeanFactory regitry = new GPDefaultListableBeanFactory();
    ...
    private void doAutowrited() {
        ...
        for(Map.Entry<String,GPBeanDefinition> beanDefinitionEntry : regitry.beanDefinitionMap.entrySet()){
